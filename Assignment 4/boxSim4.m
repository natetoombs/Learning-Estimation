...
boxParam4 % Load Params

if param.show_animation
    truth_animation = boxAnimation4(param, 0, param.st_dev, 'b', 1);
    est_animation = boxAnimation4(param, 1, param.st_dev, 'g', 0);
    ref_animation = boxAnimation4(param, 0, param.st_dev, 'k', 0);
end
dataPlot = dataPlotter4(param);
...
function out = jacobianH(X_hat,X_ref)
    x_m = X_ref(1) - X_hat(1);
    y_m = X_ref(2) - X_hat(2);
